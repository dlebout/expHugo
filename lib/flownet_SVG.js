...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_24_d3_shape__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_24_d3_shape__["d"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_24_d3_shape__["e"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_24_d3_shape__["f"]; });
...
function startTransitionFPS(link, FPS) {
  ...
  function fpsTransition(link, delay, step, limit, start, offset, adjust) {
    if (step === limit) {
      link.transition().delay(delay).duration(0).ease(__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* easeLinear */]).attr('stroke-dashoffset', offset + adjust).on('start', function () {
        fpsTransition(link, delay, 0, limit, start - offset, offset - offset, adjust);
      });
    } else {
      link.transition().delay(delay).duration(0).ease(__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* easeLinear */]).attr('stroke-dashoffset', start + adjust + (offset + adjust - (start + adjust)) / limit * step).on('start', function () {
...
function startTransitionSVG(link) {
  ...
  function motionDash(start, offset, adjust) {
    link.attr('stroke-dashoffset', start + adjust).transition().duration(function (d) {
      return computeSpeed(Number(this.getAttribute('speed')), offsetMinusFrequency);
    }).ease(__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* easeLinear */]).attr('stroke-dashoffset', offset + adjust).on('end', function () {
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__src_linear__["a"]; });
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = interpolateLink;
/* harmony export (immutable) */ __webpack_exports__["b"] = updateLinkPoints;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(10);
...
function interpolateLink(interpolation) {
  ...
  switch (interpolation) {
    case 'linear':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["f" /* curveLinear */]);
      break;
    case 'stepBefore':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* curveStepBefore */]);
      break;
    case 'stepAfter':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* curveStepAfter */]);
      break;
    case 'basis':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* curveBasis */]);
      break;
    case 'basis-open':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* curveBasisOpen */]);
      break;
    case 'bundle':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* curveBundle */]);
      break;
    case 'cardinal-open':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["e" /* curveCardinalOpen */]);
      break;
    case 'cardinal':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* curveCardinal */]);
      break;
    case 'natural':
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["g" /* curveNatural */]);
      break;
    default:
      lineFunction.curve(__WEBPACK_IMPORTED_MODULE_0_d3__["f" /* curveLinear */]);
  }
...
function updateLinkPoints(source, link, target) {
...
/* harmony export (immutable) */ __webpack_exports__["graph"] = graph;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(10);
...
flownet_svg_graph.prototype.links = function (data) {
  this.groupGraph.select('#edges').selectAll("newData").data(data).enter().append('g').attr('id', function (d, i) {
  ...
  this.groupGraph.select('#particles').selectAll("newData").data(data).enter().append('g').attr('id', function (d, i) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_d3__["q" /* select */](this).append('g').attr('id', 'mainPath_' + String(d.id)).append('path').attr('id', function (d, i) {
...
flownet_svg_graph.prototype.select = function (id) {
  let nodes = this.groupGraph.select('#nodes').selectAll("g").filter(function () {
...
flownet_svg_graph.prototype.node_properties = function (property, value) {
  ...
  if (property.split("_")[0] === "label") {
    ...
    if (!svgProp) {
      ...
      if (svgProp === "text") {
        this.groupGraph.select('#nodes').selectAll('text').filter(function (d, i) {
    ...
    let filter = this.filter;
    if (!svgProp) {
      this.groupGraph.select('#nodes').selectAll('*').filter(function (d, i) {
        if (!filter) return true;
        if (typeof filter === 'function') return filter(d, i);
        return filter;
      ...
      if (svgProp === "cx" || svgProp === "cy") {
        this.groupGraph.select('#links').selectAll('g').filter(function () {
          ...
          __WEBPACK_IMPORTED_MODULE_3__biblio_svg_graph_links_js__["b" /* updateLinkPoints */](that.groupGraph.select("#nodes").select("#node_" + source), this, that.groupGraph.select("#nodes").select("#node_" + target));
        });
      }
    }
  }
...
flownet_svg_graph.prototype.link_properties = function (property, value) {
  ...
  if (property === 'interpolation') {
    this.groupGraph.select('#links').selectAll('g').filter(function (d) {
    ...
    this.groupGraph.select('#links').selectAll('g').filter(function (d, i) {
      if (!filter) return true;
      if (typeof filter === 'function') return filter(d, i);
      return filter;
    }).filter(function () {
    ...
    this.groupGraph.select('#links').selectAll('g').filter(function (d, i) {
      ...
      return this.getAttribute('id').includes('edge');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__type__ = __webpack_require__(44);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_2__src_line__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_17__src_curve_basisOpen__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_curve_basis__ = __webpack_require__(49);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_18__src_curve_basis__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__src_curve_bundle__ = __webpack_require__(444);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_19__src_curve_bundle__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_21__src_curve_cardinalOpen__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_curve_cardinal__ = __webpack_require__(50);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_22__src_curve_cardinal__["b"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_27__src_curve_linear__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_29__src_curve_natural__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_30__src_curve_step__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_30__src_curve_step__["b"]; });
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = stepBefore;
/* harmony export (immutable) */ __webpack_exports__["a"] = stepAfter;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = flownet_svg_subgraph;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__biblio_svg_graph_animation_js__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__biblio_svg_graph_nodes_js__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__biblio_svg_graph_links_js__ = __webpack_require__(175);
...
function flownet_svg_subgraph(nodes, edges, particles) {
  this.nodes = nodes;
  this.edges = edges;
...
flownet_svg_subgraph.prototype.select = function (id) {
  let nodes = this.nodes.filter(function () {
    return this.getAttribute("id").split('_')[1] === id;
  });
  let edges = this.edges.filter(function () {
    return this.getAttribute("id").split('_')[1] === id;
  });
  let particles = this.particles_group.filter(function () {
    return this.getAttribute("id").split('_')[1] === id && this.getAttribute("id").split('_')[0] === "link";
  });
...
flownet_svg_subgraph.prototype.filters = function (fun) {
  let nodes = this.nodes.filter(function (d, i) {
    return fun(d, i);
  });
  let edges = this.edges.filter(function (d, i) {
    return fun(d, i);
  });
  let particles = this.particles_group.filter(function (d, i) {
    return fun(d, i);
  });
...
flownet_svg_subgraph.prototype.node_properties = function (property, value) {
  ...
  if (property.split("_")[0] === "label") {
    ...
    if (!svgProp) {
      ...
      if (svgProp === "text") {
        this.nodes.selectAll('text').filter(function (d, i) {
          if (!filter) return true;
          if (typeof filter === 'function') return filter(d, i);
          return filter;
        }).text(value);
    ...
    let filter = this.filter;
    if (!svgProp) {
      this.nodes.selectAll('*').filter(function (d, i) {
        if (!filter) return true;
        if (typeof filter === 'function') return filter(d, i);
        return filter;
      }).style(property, value);
...
flownet_svg_subgraph.prototype.link_properties = function (property, value) {
  ...
  if (property === 'interpolation') {
    ...
    this.particles_group.filter(function (d) {
      return this.getAttribute('id').includes('link_');
    }).filter(function (d, i) {
      if (!filter) return true;
      if (typeof filter === 'function') return filter(d, i);
    ...
    this.edges.filter(function (d, i) {
      ...
      __WEBPACK_IMPORTED_MODULE_3__biblio_svg_graph_links_js__["b" /* updateLinkPoints */](this);
    });
    this.particles_group.selectAll('g').filter(function (d, i) {
      if (!filter) return true;
      if (typeof filter === 'function') return filter(d, i);
      return filter;
    }).filter(function () {
    ...
    this.edges.selectAll('path').filter(function (d, i) {
      if (!filter) return true;
      if (typeof filter === 'function') return filter(d, i);
      return filter;
    }).attr(convertLinkPropertyToSVG(property), value);
...
flownet_svg_subgraph.prototype.particles = function (property, value) {
  ...
  switch (property) {
    case 'computationalMethod':
      this.particles_group.selectAll('path').filter(function (d, i) {
        if (!filter) return true;
        if (typeof filter === 'function') return filter(d, i);
        return filter;
      }).filter(function (d) {
...
flownet_svg_subgraph.prototype.start = function () {
  ...
  if (FPS === 'auto') {
    this.particles_group.selectAll('path').filter(function (d) {
      return this.getAttribute('id').includes('particles');
    }).each(function (d) {
      __WEBPACK_IMPORTED_MODULE_1__biblio_svg_graph_animation_js__["c" /* startTransitionSVG */](__WEBPACK_IMPORTED_MODULE_0_d3__["q" /* select */](this));
    });
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = startTransitionSVG_fire;
/* harmony export (immutable) */ __webpack_exports__["a"] = computeInteractiveParticleRender;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__svg_graph_animation_js__ = __webpack_require__(91);
