            ...
            if (visual_attr.slice(0, 6) == 'color_') {
                ...
                for (var i = 0; i < this.sparkiz.links.length; i++) {
                    if (typeof (arguments[1]) == 'string') {
                        ...
                        a = callback(this.sparkiz.links[i], i);
            ...
            if (visual_attr.slice(0, 9) == 'velocity_') {
                ...
                for (var i = 0; i < this.sparkiz.links.length; i++) {
                    if (typeof (arguments[1]) == 'number') {
                        ...
                        value = parseFloat(callback(this.sparkiz.links[i], i));
                    }
            ...
            switch (visual_attr) {
                case "color":
                    for (var i = 0; i < this.sparkiz.links.length; i++) {
                        ...
                        for (var k = 0; k < this.sparkiz.number_max_gates; k++)
                ...
                case "wiggling":
                    for (var i = 0; i < this.sparkiz.links.length; i++) {
                        ...
                        for (var k = 0; k < this.sparkiz.number_max_gates; k++)
                            this.sparkiz.links[i].wiggling[k] = value;
                    }
                    return this;
...
var Visualisation = (function () {
    ...
    Visualisation.prototype.init = function () {
        this.camera = new THREE.OrthographicCamera(this.WIDTH / -2, this.WIDTH / 2, this.HEIGHT / 2, this.HEIGHT / -2, 0.01, 1000);
...
var UI = (function () {
    function UI(ConfluentGraph, scene, camera, renderer, raycaster, div) {
...
(function (Sparkiz_1) {
    var Sparkiz = (function () {
        ...
        Sparkiz.prototype.draw_us = function (projection) {
            var array = [];
            var self = this;
        ...
        Sparkiz.prototype.draw_map = function (projection, path) {
            var self = this;
            var array = [];
        ...
        Sparkiz.prototype.map_links_nodes = function () {
        ...
        Sparkiz.prototype.launch_network2 = function (time) {
            var _this = this;
        ...
        Sparkiz.prototype.launch_network = function (time) {
            ...
            window.setTimeout(function () {
                ...
                console.log(_this.links);
                console.log(_this.scene);
                console.log(typeof (_this.callback));
        ...
        Sparkiz.prototype.createLinks = function () {
            ...
            for (var i = 0; i < this.links.length; i++) {
                ...
                this.links[i].gate_position = Array.apply(null, Array(this.number_max_gates + 1)).map(Number.prototype.valueOf, 0);
                this.links[i].gate_velocity = Array.apply(null, Array(this.number_max_gates + 1)).map(Number.prototype.valueOf, 1.0);
        ...
        Sparkiz.prototype.clockwiseSorting = function (input, basic) {
