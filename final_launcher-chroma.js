...
app.get('/read_csv', function (req, res) {
    var reader = csv.createCsvFileReader("./followup/particles-followup-chroma.csv", { separator : ',', columnsFromHeader: true  });
...
function create_db_expe(staticVariables){
  ...
  db_expe = csv.createCsvStreamWriter(fs.createWriteStream('db/logs/log_user_chroma_'+id_utilisateur+'_'+date+'.csv'), { separator : ';' });
